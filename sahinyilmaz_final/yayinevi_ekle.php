...
<form action="yayinevi_eklendi.php" method="post">
    ...
    Yayinevi URL: <textarea name="YayineviURL" rows="2" cols="50"></textarea><br><br>
    Yayinevi Eposta: <input type="text" name="yayineviEposta"><br><br>
    <input type="submit" value="Yeni Yayinevi Ekle">
</form>
<!-- KODLAR -->   
</main>
