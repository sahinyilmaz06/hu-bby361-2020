<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yayınevi WHERE yayineviKayitNo = $guncellenecek");
...
<!-- KODLAR -->
<h1>Yayinevi Güncelle</h1>
<form action="yayinevi_guncellendi.php" method="post">
    Yayinevi Adı: <input type="text" name="yayineviAdi" value="<?php echo $satir["yayineviAdi"] ;?>"><br><br>
    Yayinevi URL: <textarea name="yayineviURL" rows="2" cols="50"><?php echo $satir["yayineviURL"]?></textarea><br><br>
    Yayinevi Eposta: <input type="text" name="yayineviEposta" value="<?php echo $satir["yayineviEposta"] ;?>">
    <input type="hidden" value="<?php echo $satir["yayineviKayitNo"] ;?>" name="yayineviKayitNo">
    <input type="submit" value="Yayinevi Güncelle">
</form>
<!-- KODLAR -->   
</main>
