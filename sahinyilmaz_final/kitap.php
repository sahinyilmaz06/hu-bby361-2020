...
$sorgu = mysqli_query($baglanti, 
   "SELECT X.kitapKayitNo, X.kitapKayitTarih, X.kitapAdi, X.kitapISBN, X.kitapBasimYeri, X.kitapBasimTarih, X.kitapDil, X.kitapSayfaSayisi, CONCAT(Y.yazarAdi,' ', Y.yazarSoyadi) AS AdSoyad, Z.yayineviAdi
    FROM kitap X, yazar Y, yayınevi Z
    WHERE X.yayineviKayitNo = Z.yayineviKayitNo AND 
            X.yazarKayitNo = Y.yazarKayitNo  ");
?>
