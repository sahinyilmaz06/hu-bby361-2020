<?php
    ...
    $sorgu = "INSERT INTO yayınevi (yayineviAdi, yayineviURL, yayineviEposta)
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yayınevi ORDER BY yayineviKayitNo DESC");
...
<meta name="theme-color" content="#563d7c">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="yayinevi.php">Kitap Türü İşlemleri</a>
      </li>
    </ul>
...
<!-- KODLAR -->
<!-- KODLAR -->
<h1>Yayinevi İşlemleri</h1>
<p><a href="yayinevi.php">Yeni Yayinevi Ekle</a></p>
<?php
echo("<table border=1 width=80%>");
    echo("<tr>");
    echo("<td><b>Yayinevi No</b></td>");
    echo("<td><b>Yayinevi Kayit Tarihi</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu)){
    ...
    echo("<td><a href='yayinevi_guncellenecek.php?yayineviKayitNo=".$satir["yayineviKayitNo"]."'>Güncelle</a></td>");
