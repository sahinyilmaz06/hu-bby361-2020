    ...
    $sorgu = "UPDATE kitap SET kitapAdi = '$kitapAdi', kitapISBN = '$kitapISBN', kitapBasimYeri = '$kitapBasimYeri', kitapBasimTarih = '$kitapBasimTarih', kitapDil = '$kitapDil', kitapSayfaSayisi = '$kitapSayfaSayisi', yazarKayitNo = '$yazarKayitNo', yayineviKayitNo = '$yayineviKayitNo' WHERE kitapKayitNo = $kitapKayitNo";
