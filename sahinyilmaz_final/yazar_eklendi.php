<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yazar ORDER BY yazarKayitNo DESC");
...
while($satir = mysqli_fetch_assoc($sorgu)){
    ...
    echo("<td><a href='yazar_guncellenecek.php?yazarKayitNo=".$satir["yazarKayitNo"]."'>Güncelle</a></td>");
